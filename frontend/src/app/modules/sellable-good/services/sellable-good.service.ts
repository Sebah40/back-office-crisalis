...
export class SellableGoodService {
  ...
  private sellableGoodListData: BehaviorSubject<SellableGood[]> =
    new BehaviorSubject<SellableGood[]>([]);
  ...
  create(sellableGood: SellableGood): Observable<SellableGood> {
    return this.http.post<SellableGood>(`${this.URL}/create`, sellableGood);
  }
