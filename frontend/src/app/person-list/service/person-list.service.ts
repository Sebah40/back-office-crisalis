...
import { ResponseCreateUser } from "src/app/users/interfaces/ResponseCreateUser.type";
...
@Injectable({
  ...
  export class PersonService {
    ...
    private personListData: BehaviorSubject<IPersonGet[]> = 
    new BehaviorSubject <IPersonGet[]> ([]);
